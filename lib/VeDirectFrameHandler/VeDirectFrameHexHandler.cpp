 ...
 */
bool VeDirectFrameHandler::disassembleHexData(VeDirectHexData &data) {
    bool state = false;
 ...
 */
bool VeDirectFrameHandler::sendHexCommand(VeDirectHexCommand cmd, uint16_t id, uint32_t value, uint8_t valsize) {
    bool ret = false;
